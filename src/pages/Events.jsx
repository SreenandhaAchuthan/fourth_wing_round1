        ...
        <div className="mt-8 sm:mt-12 events-grid-modern w-full">
          ...
          >
            <div className="event-date-modern">
              <span className="day-modern">18</span>
              <span className="month-modern">FEB</span>
            </div>
            <div className="event-details-modern">
              <div className="event-header-modern">
                <h2 className="event-title-modern">Fourth Wing</h2>
                <span className="event-badge-modern event-ended-badge-modern">Began</span>
              </div>
          ...
          {events.map((event, idx) => {
            ...
            // Hardcode override for Fourth Wing date
                  ...
                  <div className="event-footer-modern">
                    {event.participantLimit && (
                      <div className="participant-info-modern">
                        ...
                        {event.isEnded && (
                          <div className="event-ended-badge-modern-inline">Began</div>
                        )}
                      </div>
                    )}
                    {event.isEnded ? (
